...
<section class="section service" id="service" aria-label="service">
  <div class="container">
    ...
    <form class="donor-form" action="process_donor.php" method="post">
  ...
  <div class="form-group">
    ...
    <select id="blood-type" name="blood_type">
      <option id="blood-type" value="A+">A+ </option>
      <option id="blood-type" value="A-">A-</option>
      <option id="blood-type" value="B+">B+</option>
      <option id="blood-type" value="B-">B-</option>
      <option id="blood-type" value="AB+">AB+</option>
      <option id="blood-type" value="AB-">AB-</option>
      <option id="blood-type" value="O+">O+</option>
      <option id="blood-type" value="O-">O-</option>
    </select>
  </div>
