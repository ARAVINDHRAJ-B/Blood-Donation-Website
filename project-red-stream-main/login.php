    ...
    if ($stmt->num_rows > 0) {
        ...
        if (password_verify($password, $hashedPassword)) {
            ...
            if (isset($_POST["remember_me"]) && $_POST["remember_me"] === "1") {
                ...
                $cookie_value = $email; // Consider if it's safe to store email directly
                $cookie_expiry = time() + (86400 * 30); // 30 days (86400 seconds per day)
                setcookie($cookie_name, $cookie_value, $cookie_expiry, "/", "", true, true); // Secure and HttpOnly flags
            }
        ...
        <div class="container">
          ...
          <?php
            if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
                echo '<div class="form-title-login">Welcome back</div>';
            }
            ?>
